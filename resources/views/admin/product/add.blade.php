            ...
            <form action="{{ url('insert-product') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="small_description" rows="3" required class="form-control border"></textarea>
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="any" min="0" name="original_price" required class="form-control border">
                    </div>
                    <div class="col-md-6 mb-3">
